...
function OnBind(self)
	...
	attr.ScrollAniTemplate = tm:GetTemplate("Thunder.ScrollBar.ScrollPosAni.Template","AnimationTemplate")
...
local attr = self:GetAttribute()
  ...
  local prebtnattr = prebtn:GetStyle()
  if attr.Type == "v" then
  	prebtnattr.bkg_normal_texture = "texture.vsb.prebtn.normal1"
	else
		prebtnattr.bkg_normal_texture = "texture.hsb.prebtn.normal1"
	end
	...
	local nextbtnattr = nextbtn:GetStyle()
  if attr.Type == "v" then
  	nextbtnattr.bkg_normal_texture = "texture.vsb.nextbtn.normal1"
	else
		nextbtnattr.bkg_normal_texture = "texture.hsb.nextbtn.normal1"
	end
